                    ...
                    <div className="flex flex-col space-y-6" data-dev-hint="optional div for having an extra footer navigation">
                        ...
                        <nav data-dev-hint="main navigation">
                            <Link to="add-service" className="flex items-center space-x-2 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
                                <PlusIcon className='h-6'/><span>Add services</span>
                            </Link>
                            <Link to="manage-service" className="flex items-center space-x-2 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
                                <MagnifyingGlassCircleIcon className='h-6'/><span>Manage services</span>
                            </Link>
                            <Link to="all-users" className="flex items-center space-x-2 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
                                <MagnifyingGlassCircleIcon className='h-6'/><span>All users</span>
                            </Link>
                        </nav>
                    </div>
